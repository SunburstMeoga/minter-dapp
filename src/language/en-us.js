export default {
  ...
  toast: {
    ...
    haveNotCanReleasePMT: "There is no PMT to release yet",
    notTimeToRelease: "Release time has not yet arrived",
    releaseSuccess: "Release successful",
    releaseFail: "Failed to release PMT, please try again",
    enterExchangeAmount: "Please enter the exchange amount",
    handlingFee: "({handlingFee} handling fee required)",
  ...
  wallet: {
    ...
    gift: 'Give away',
    coherent: 'Minting',
    staticIncome: 'Investment Income',
    dynamicIncome: 'Referral Bonus',
    transfer: 'Transfer',
    market: 'Market',
    release: "Release",
    register: "Register",
  ...
  assistance: {
    ...
    preAddress: "Placement address",
    nextAddress: "New address",
  ...
  coherents: {
    ...
    canRelease: "Can be released",
    remainingRelease: "Remaining release volume",
  ...
  modalConfirm: {
    ...
    confirmTransferRT: "Confirm to transfer {amount}RT to {address}? This behavior is irreversible!",
    // successTransferRT: "已成功轉賬 {amount} RT",
    successTransferRT: "Successfully transferred {amount} RT",
    ...
    confirmExchangeBTToUSD3: "Confirm to exchange {amount} BT for {usd3} USD3? 10% ({handlingFee} BT) handling fee has been deducted from USD3",
    // confirmExchangeBTToBT: "是否確認將 {amount} BT 兌換為 {RT} RT",
    confirmExchangeBTToBT: "Confirm to exchange {amount} BT for {RT} RT?",
    successExchangeUSD3: "Successfully exchanged for {amount} USD3",
    exchangeFail: "Exchange failed, please try again",
    successExchangeRT: "Successfully exchanged for {amount} RT",
    authorize: "Please authorize",
    pleaseAuthorize: "{type} authorization is required, please complete the authorization first",
    toAuthorize: "To authorize",
    successAuthorize: "Authorization successful",
    authorizeFail: "{type} authorization failed, please authorize again",
    // confirmExchangeMTToUSD3: "是否確認將 {amount} MT 兌換為 {usd3} USD3，已扣除10%（{handlingFee} MT）手續費",
    confirmExchangeMTToUSD3: "Confirm to convert {amount} MT for {usd3} USD3? 10% ({handlingFee} MT) handling fee has been deducted",
    // confirmExchangeMTToRT: "是否確認將 {amount} MT 兌換為 {rt} RT，已扣除5%（{handlingFee} MT）手續費",
    confirmExchangeMTToRT: "Confirm to convert {amount} MT for {rt} RT? 5% ({handlingFee} MT) handling fee has been deducted",

    cantTransfer: "The {type} balance is insufficient and the transfer operation cannot be performed.",
    postRelease: "Can be released after {time}",
    confirmSaleNFT: "Confirm to place an order for NFT with Token ID {tokenID}?",
    onSale: "Listing for sale...",
    saleNFTFail: "The NFT order with Token ID {tokenID} failed, please place the order again.",
    checkAuthFail: "Failed to check {type} authorization status, please try again",
    confirmCancelSale: "Whether to cancel the sales order for NFT with Token ID {tokenID}",
    canceling: "Canceling...",
    cancelFail: "Cancellation failed, please try again",
    postSale: "Available for sale after {time}",
    saleLimit: "You currently have placed orders for {count} NFTs. You can continue to place orders after selling one, and you can only place orders for 4 NFTs within 24 hours.",
    cantSale: "A total of 4 NFTs can be sold and placed for sale at the same time within 24 hours. At present, once you place a sales order for {count} NFTs, you can continue to place orders after {time}",
    notPackage: "You are currently not purchasing a package",
    cantBuyNFTInPool: "The package level you purchased cannot purchase NFT from this card pool",
    getBalanceFail: "Failed to get balance, please try again",
    error: "Error",
    notBalance: "Insufficient balance",
    notEnoughBalance: "The current package price is {amount} {currency}, and your {currency} balance is insufficient.",
    confirmBuyPackage: "Confirm to purchase the {package} package?",
    successBuyPackage: "Successfully purchased {package} package",
    addressDoesNotExist: "The sponsor address does not exist",
    addressTipsOne: "The pairing address must be in the point map of the upline address",
    addressTipsTwo: "Purchase failed: This address already has an upline",
    addressTipsThree: "The pairing address must be in your point map",
    addressTipsFour: "The invitation address must be in your site map",
    ...
    enterPreAddress: "Type in Placement address",
    enterMyAddress: 'Type in my address',
    choosePackage: "Please select a package",
    enterSearchNextAddr: "Please enter the downline address you want to search for",
    enterSearchUseAddr: "Please enter a valid downline address",
    addressTipsFive: "You cannot query address information that is not in your point map",
  ...
  opertingLog: {
    ...
    distributionOfPrizes: "Prize distribution situation",
    expiryTime: "Expiry time",
    zeroingTime: "Clear time",
    purchaseAmount: "Purchase amount",
    opertingType: "Operation type",
    time: "Time",
    operatingAddr: "Operation address",
    amount: "Amount",
    exhangeType: "Exchange type",
    transType: "Transaction type",
    checkoutTime: "Settlement time",
    awarded: 'Prize distributed',
    noAward: "No prize distributed"
  },
  promiseCard: {

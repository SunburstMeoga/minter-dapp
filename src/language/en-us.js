export default {
  ...
  modalConfirm: {
    ...
    saleLimit: "You currently have placed orders for {count} NFTs. You can continue to place orders after selling one, and you can only place orders for 4 NFTs within 20 minutes.",
    cantSale: "A total of 4 NFTs can be sold and placed for sale at the same time within 20 minutes. At present, once you place a sales order for {count} NFTs, you can continue to place orders after {time}",

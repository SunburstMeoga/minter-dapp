    ...
    <div class="w-full h-full pt-16">
        <div class="h-full">
            <div class="w-full h-full flex flex-col items-center justify-start">
                ...
                <div class="w-11/12 mb-2 rounded overflow-hidden">
                ...
                <div class="text-xs w-10/12 mr-auto ml-auto text-gray-300 text-center mb-8">
                    {{ $t('news.content') }}
                </div>
                <div class="flex justify-center items-center w-full">
                    <div class="w-11/12 py-3 text-center operating-button text-white rounded">{{ $t('news.exploratory') }}
                    </div>
                </div>
            </div>
        </div>
